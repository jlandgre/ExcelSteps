...
Sub test_ReadMdlDestRow(procs)
    ...
    With tst
        ...
        ReadMdlDestRow tst, R_MI, mdlDest
...
Sub test_ReadStepsRow(procs)
    ...
    With tst
        ...
        .Assert tst, R_MI.ReadStepsRow(R_MI, tbls, mdlDest.rngStepsVars)
...
Sub test_SetBooleanFlags(procs)
    ...
    With tst
        ...
        'First row in model (Group name only)
        Set mdlDest.rowCur = mdlDest.cellHome.EntireRow
        SetRowBooleanFlags tst, R_MI, mdlDest, tbls
    ...
    End With
End Sub
Sub SetRowBooleanFlags(tst, R_MI, mdlDest, tbls)
    With tst
        .Assert tst, R_MI.Init(R_MI)
    ...
    End With
End Sub
Sub ReadMdlDestRow(tst, R_MI, mdlDest)
    With tst
        .Assert tst, R_MI.Init(R_MI)
        .Assert tst, R_MI.ReadMdlDestRow(R_MI, mdlDest)
    End With
...
Sub CheckWrittenRowValues(tst, tblImp, iRow, aryExpect, Optional IsConvertNumerics = True)
    ...
    End With
    tst.TestRngVals tst, rng, aryExpect, ConvertNumerics:=IsConvertNumerics
