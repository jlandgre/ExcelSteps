...
'           10/30/25 IsSetColRngs=False for tblSteps
'
Function PrepExcelStepsSht(refr, tblSteps, Optional IsReformat = False) As Boolean
    ...
    With refr
        ...
        If IsReformat Then
            ...
            If Not tblSteps.Provision(tblSteps, .wkbkS, False, sht:=.shtS, IsSetTblNames:=False, IsSetColNames:=False, IsSetColRngs:=True) Then GoTo ErrorExit
