'ExcelSteps_ErrorHandling_cls.vb
'Version 12/3/25
...
Sub RecordErr(Locn, Optional ByRef CallingFunction)
    ...
    With errs
        ...
        'If new error (e.g. occurs in calling function) lookup codes
        If .IsNewErr Then
