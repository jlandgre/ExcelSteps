...
Sub Populate_Errs_Default()
	...
	If Not SheetExists(errs.wkbkE, ExcelSteps.shtErrors) Then _
		AddSheet errs.wkbkE, ExcelSteps.shtErrors, _
			errs.wkbkE.Sheets(errs.wkbkE.Sheets.Count).Name

	Set wksht = errs.wkbkE.Sheets(ExcelSteps.shtErrors)
